...
export const Header = ({
  ...
  return (
    <header className="bg-slate-950/90 border-b border-slate-800 px-4 lg:px-6 py-3.5 flex flex-col gap-4 sticky top-0 z-30 shadow-lg backdrop-blur supports-[backdrop-filter]:bg-slate-950/70">
      <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
        ...
        {/* Actions */}
        <div className="flex gap-2 justify-end self-end xl:self-center flex-wrap">
          ...
          <button 
            onClick={onImport}
            className="px-3 py-2 bg-slate-800 hover:bg-slate-750 border border-slate-700 text-sm font-semibold rounded-lg text-slate-200 transition-all flex items-center gap-2 shadow"
          >
